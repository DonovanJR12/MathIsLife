...
public class SurfaceArea {
        ...
        while(select != 7){
            ...
            switch(select){
                case 1: 
                    ...
                    System.out.print(SARectanglarPrism(length, width, hieght));
                    break;
                case 2: 
                    ...
                    System.out.print("What is the width measurement: ");
                    width = SASelection.nextDouble();
                    System.out.print(SARightPrism(base, width, hieght));
                    break;
                case 3:                     
                    System.out.print("What is the hieght measurement: ");
                    hieght = SASelection.nextDouble();
                    ...
                    System.out.print(SACylinder(radius, hieght));
                    break;
                case 4: 
                    System.out.print("What is the length measurement: ");
                    ...
                    System.out.print("What is the base measurement: ");
                    base = SASelection.nextDouble();
                    System.out.print(SAPyramid(base, width, sideLength));
                    break;
                case 5: 
                    System.out.print("What is the length measurement: ");
                    length = SASelection.nextDouble();
                    System.out.print("What is the radius measurement: ");
                    radius= SASelection.nextDouble();
                    System.out.print(SACone(radius, length));
                    break;
                case 6:  
                    System.out.print("What is the radius measurement: ");
                    radius = SASelection.nextDouble();
                    System.out.print(SASphere(radius));
                    break;
                case 7: 
    ...
    */
    public static double SARectanglarPrism(double length, double width, double hieght){
        return 2.0*length*width+2.0*length*hieght+2.0*width*hieght;
    }
    ...
    */
    public static double SARightPrism(double base, double width, double hieght){
        return (((2.0*base+2.0*width)*hieght) + (2.0*(base*width)));
    }
    ...
    public static double SACylinder(double radius, double hieght){
        return ((2.0*PI*radius*hieght)+(2.0*PI*radius*radius));
    }
   ...
   /* public static void SAPyramid(double base, double width, double side){
    ...
    public static double SAPyramid(double base, double width, double side){
        return (((1.0/2.0)*(2.0*base+2.0*width)*side)+(base*width));
    }
    ...
    public static double SACone(double radius, double side){
